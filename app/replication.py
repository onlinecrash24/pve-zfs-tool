...
from app.tasks import start_task as _start_task, get_task  # noqa: F401  (re-exported)


def start_task(name: str, fn, *args, **kwargs) -> str:
    """Thin shim around app.tasks.start_task that pins the thread-name
    prefix to ``repl`` for replication-specific tasks."""
    return _start_task(name, fn, *args, prefix="repl", **kwargs)
